...
import org.jurassicraft.client.gui.Vec2d;
...
public class HandlerInstance {
	...
	public void handleDraft(boolean loading) {
		...
		drawInterface(width, height, scale, loading);
	...
	public void drawInterface(int width, int height, int scale, boolean loading) {
		int bufferDimensions = (int)(512 * getMapScale());
		int textureDimensions = 45;
		...
		this.map.renderChunks((EntityPlayer) this.mc.player, bufferDimensions, mapWidth, true);
